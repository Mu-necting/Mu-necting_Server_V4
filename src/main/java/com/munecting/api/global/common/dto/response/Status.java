...
public enum Status {
    ...
    NOT_COMMENT_WRITER(HttpStatus.UNAUTHORIZED, "COMMENT401", "댓글 작성자가 아닙니다."),

    // User 오류 응답
    USER_NOT_FOUND(HttpStatus.NOT_FOUND, "USER404", "존재하지 않는 회원입니다."),

    // 닉네임 오류 응답
    NICKNAME_GENERATION_FAILED(HttpStatus.CONFLICT, "USER_NICKNAME500", "닉네임 생성에 실패하였습니다."),
    ...
    // 좋아요 오류 응답
    LIKE_REQUEST_CONFLICT(HttpStatus.CONFLICT, "LIKE409", "좋아요 요청 처리 중 문제가 발생했습니다. 잠시 후 다시 시도해 주세요."),
